# [Command] _networkfabric edgeconnector show_
...
- Show an EdgeConnector resource.
    ```bash
        networkfabric edgeconnector show --resource-group example-rg --resource-name example-edgeConnector
    ```
