# [Group] _networkfabric l2domain_
...
- [commit-config](/Commands/networkfabric/l2domain/_commit-config.md)
...
- [validate-config](/Commands/networkfabric/l2domain/_validate-config.md)
