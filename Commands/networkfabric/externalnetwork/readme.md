# [Group] _networkfabric externalnetwork_
...
- [update-bfd-admin-state](/Commands/networkfabric/externalnetwork/_update-bfd-admin-state.md)
...
- [update-static-route-bfd-admin-state](/Commands/networkfabric/externalnetwork/_update-static-route-bfd-admin-state.md)
