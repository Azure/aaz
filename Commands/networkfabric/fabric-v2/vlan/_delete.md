# [Command] _networkfabric fabric-v2 vlan delete_
...
- Delete a VLAN resource.
    ```bash
        networkfabric fabric-v2 vlan delete --resource-group example-rg --fabric-v2-name example-fabric --resource-name example-vlan
    ```
