# [Command] _networkfabric fabric-v2 vlan show_
...
- Show a VLAN resource.
    ```bash
        networkfabric fabric-v2 vlan show --resource-group example-rg --fabric-v2-name example-fabric --resource-name example-vlan
    ```
