# [Command] _networkfabric fabric-v2 delegation show_
...
- Show a FabricDelegation resource.
    ```bash
        networkfabric fabric-v2 delegation show --resource-group example-rg --fabric-v2-name example-fabric --resource-name example-delegation
    ```
