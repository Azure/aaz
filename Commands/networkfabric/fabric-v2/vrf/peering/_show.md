# [Command] _networkfabric fabric-v2 vrf peering show_
...
- Show a VRF Peering resource.
    ```bash
        networkfabric fabric-v2 vrf peering show --resource-group example-rg --fabric-v2-name example-fabric --vrf-name example-vrf --resource-name example-peering
    ```
