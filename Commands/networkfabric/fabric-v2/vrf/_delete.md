# [Command] _networkfabric fabric-v2 vrf delete_
...
- Delete a VRF resource.
    ```bash
        networkfabric fabric-v2 vrf delete --resource-group example-rg --fabric-v2-name example-fabric --resource-name example-vrf
    ```
