# [Command] _networkfabric fabric-v2 vrf delegation delete_
...
- Delete a VRF Delegation resource.
    ```bash
        networkfabric fabric-v2 vrf delegation delete --resource-group example-rg --fabric-v2-name example-fabric --vrf-name example-vrf --resource-name example-delegation
    ```
