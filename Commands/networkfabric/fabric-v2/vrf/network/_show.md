# [Command] _networkfabric fabric-v2 vrf network show_
...
- Show a VRF Network resource.
    ```bash
        networkfabric fabric-v2 vrf network show --resource-group example-rg --fabric-v2-name example-fabric --vrf-name example-vrf --resource-name example-network
    ```
