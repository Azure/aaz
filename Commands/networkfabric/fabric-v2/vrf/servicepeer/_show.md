# [Command] _networkfabric fabric-v2 vrf servicepeer show_
...
- Show a ServicePeer resource.
    ```bash
        networkfabric fabric-v2 vrf servicepeer show --resource-group example-rg --fabric-v2-name example-fabric --vrf-name example-vrf --resource-name example-servicepeer
    ```
