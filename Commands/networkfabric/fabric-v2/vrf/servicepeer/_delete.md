# [Command] _networkfabric fabric-v2 vrf servicepeer delete_

Delete the specified ServicePeer.
...
- Delete a ServicePeer resource.
    ```bash
        networkfabric fabric-v2 vrf servicepeer delete --resource-group example-rg --fabric-v2-name example-fabric --vrf-name example-vrf --resource-name example-servicepeer
    ```
