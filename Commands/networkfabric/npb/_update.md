# [Command] _networkfabric npb update_
...
- update Network Packet Broker
    ```bash
        networkfabric npb update --resource-group "example-rg" --resource-name "example-npb" --tag "{'name': 'value'}"
    ```
