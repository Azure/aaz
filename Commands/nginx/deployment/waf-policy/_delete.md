# [Command] _nginx deployment waf-policy delete_
...
- WafPolicy_Delete
    ```bash
        nginx deployment waf-policy delete --resource-group myResourceGroup --deployment-name myDeployment --waf-policy-name myWafPolicy
    ```
