# [Command] _nginx deployment waf-policy show_
...
- WafPolicy_Get
    ```bash
        nginx deployment waf-policy show --resource-group myResourceGroup --deployment-name myDeployment --waf-policy-name myWafPolicy
    ```
