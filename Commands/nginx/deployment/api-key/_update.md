# [Command] _nginx deployment api-key update_
...
- APIKeys_Update
    ```bash
        nginx deployment api-key update --resource-group myResourceGroup --deployment-name myDeployment --api-key-name myApiKey
    ```
