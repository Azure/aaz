...
- Create a parent-child relationship between two entities
    ```bash
        monitor health-models relationship create --resource-group myRG --health-model-name myModel --name webToDb --parent-entity-name webTier --child-entity-name dbTier
    ```
