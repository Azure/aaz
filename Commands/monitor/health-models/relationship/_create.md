# [Command] _monitor health-models relationship create_
...
- Relationships_CreateOrUpdate
    ```bash
        monitor health-models relationship create --resource-group rgopenapi --health-model-name model1 --relationship-name rel1 --display-name My relationship --parent-entity-name Entity1 --child-entity-name Entity2 --tags "{key9681:ixfvzsfnpvkkbrce}"
    ```
