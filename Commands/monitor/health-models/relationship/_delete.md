# [Command] _monitor health-models relationship delete_
...
- Relationships_Delete
    ```bash
        monitor health-models relationship delete --resource-group rgopenapi --health-model-name model1 --relationship-name rel1
    ```
