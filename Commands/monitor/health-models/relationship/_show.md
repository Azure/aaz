# [Command] _monitor health-models relationship show_
...
- Relationships_Get
    ```bash
        monitor health-models relationship show --resource-group rgopenapi --health-model-name myHealthModel --relationship-name Ue-21-F3M12V3w-13x18F8H-7HOk--kq6tP-HB
    ```
