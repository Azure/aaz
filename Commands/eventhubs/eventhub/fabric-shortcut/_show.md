# [Command] _eventhubs eventhub fabric-shortcut show_

Get a Microsoft Fabric shortcut.
...
- Get a Fabric shortcut
    ```bash
        eventhubs eventhub fabric-shortcut show --resource-group contoso-rg --namespace-name contoso-eventhub --event-hub-name orders --fabric-shortcut-name orders-shortcut
    ```
