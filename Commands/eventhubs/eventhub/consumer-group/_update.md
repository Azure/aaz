# [Command] _eventhubs eventhub consumer-group update_
...
- ConsumerGroupCreate
    ```bash
        eventhubs eventhub consumer-group update --resource-group ArunMonocle --namespace-name sdk-Namespace-2661 --eventhub-name sdk-EventHub-6681 --consumer-group-name sdk-ConsumerGroup-5563
    ```
