# [Command] _eventhubs namespace private-endpoint-connection show_
...
- NameSpacePrivateEndPointConnectionGet
    ```bash
        eventhubs namespace private-endpoint-connection show --resource-group SDK-EventHub-4794 --namespace-name sdk-Namespace-5828 --private-endpoint-connection-name privateEndpointConnectionName
    ```
