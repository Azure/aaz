# [Command] _eventhubs namespace private-endpoint-connection delete_
...
- NameSpacePrivateEndPointConnectionDelete
    ```bash
        eventhubs namespace private-endpoint-connection delete --resource-group ArunMonocle --namespace-name sdk-Namespace-3285 --private-endpoint-connection-name 928c44d5-b7c6-423b-b6fa-811e0c27b3e0
    ```
