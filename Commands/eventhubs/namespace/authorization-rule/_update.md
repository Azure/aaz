# [Command] _eventhubs namespace authorization-rule update_
...
- NameSpaceAuthorizationRuleCreate
    ```bash
        eventhubs namespace authorization-rule update --resource-group ArunMonocle --namespace-name sdk-Namespace-2702 --authorization-rule-name sdk-Authrules-1746
    ```
