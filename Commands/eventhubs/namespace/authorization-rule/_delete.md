# [Command] _eventhubs namespace authorization-rule delete_
...
- NameSpaceAuthorizationRuleDelete
    ```bash
        eventhubs namespace authorization-rule delete --resource-group ArunMonocle --namespace-name sdk-Namespace-8980 --authorization-rule-name sdk-Authrules-8929
    ```
