# [Command] _eventhubs namespace network-rule-set update_
...
- NameSpaceNetworkRuleSetCreate
    ```bash
        eventhubs namespace network-rule-set update --resource-group ResourceGroup --namespace-name sdk-Namespace-6019
    ```
