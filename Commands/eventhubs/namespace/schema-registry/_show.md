# [Command] _eventhubs namespace schema-registry show_
...
- SchemaRegistryGet
    ```bash
        eventhubs namespace schema-registry show --resource-group alitest --namespace-name ali-ua-test-eh-system-1 --schema-group-name testSchemaGroup1
    ```
