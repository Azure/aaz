# [Command] _eventhubs namespace application-group update_
...
- ApplicationGroupCreate
    ```bash
        eventhubs namespace application-group update --resource-group contosotest --namespace-name contoso-ua-test-eh-system-1 --application-group-name appGroup1
    ```
