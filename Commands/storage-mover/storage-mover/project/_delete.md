# [Command] _storage-mover storage-mover project delete_
...
- Projects_Delete
    ```bash
        storage-mover storage-mover project delete --resource-group examples-rg --storage-mover-name examples-storageMoverName --project-name examples-projectName
    ```
