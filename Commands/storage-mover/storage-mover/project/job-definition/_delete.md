# [Command] _storage-mover storage-mover project job-definition delete_
...
- Projects_Delete
    ```bash
        storage-mover storage-mover project job-definition delete --resource-group examples-rg --storage-mover-name examples-storageMoverName --project-name examples-projectName --job-definition-name examples-jobDefinitionName
    ```
