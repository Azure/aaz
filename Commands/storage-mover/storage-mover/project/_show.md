# [Command] _storage-mover storage-mover project show_
...
- Projects_Get
    ```bash
        storage-mover storage-mover project show --resource-group examples-rg --storage-mover-name examples-storageMoverName --project-name examples-projectName
    ```
