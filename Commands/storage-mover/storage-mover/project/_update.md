# [Command] _storage-mover storage-mover project update_
...
- Projects_CreateOrUpdate
    ```bash
        storage-mover storage-mover project update --resource-group examples-rg --storage-mover-name examples-storageMoverName --project-name examples-projectName
    ```
