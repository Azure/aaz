# [Command] _storage-mover storage-mover connection update_
...
- Connections_CreateOrUpdate
    ```bash
        storage-mover storage-mover connection update --resource-group examples-rg --storage-mover-name examples-storageMoverName --connection-name example-connection
    ```
