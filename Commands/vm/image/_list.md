...
- VirtualMachineImage_List_MaximumSet_Gen
    ```bash
        vm image list --location aaaaaaaaaaaaaaa --publisher aaaaaa --offer aaaaaaaaaaaaaaaa --sku aaaaaaaaaaaaaaaaaaaaaaa --expand aaaaaaaaaaaaaaaaaaaaaaaa --top 18 --orderby aa
    ```
