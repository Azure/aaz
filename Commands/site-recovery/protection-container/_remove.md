# [Command] _site-recovery protection-container remove_
...
- protection-container remove
    ```bash
        site-recovery protection-container remove -g rg --fabric-name fabric1_name -n container1_name --vault-name vault_name
    ```
