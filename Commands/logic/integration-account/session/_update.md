# [Command] _logic integration-account session update_
...
- Update
    ```bash
        logic integration-account session update -g rg -n session --integration-account-name name --content "{'controlNumber':12345}"
    ```
