# [Command] _cdn origin-group delete_
...
- OriginGroups_Delete
    ```bash
        cdn origin-group delete --resource-group RG --profile-name profile1 --endpoint-name endpoint1 --origin-group-name originGroup1
    ```
