# [Command] _nf externalnetwork delete_
...
- Delete the External Network
    ```bash
        nf externalnetwork delete --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-externalnetwork"
    ```
