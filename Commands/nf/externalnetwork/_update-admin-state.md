# [Command] _nf externalnetwork update-admin-state_
...
- Update admin state of External Network
    ```bash
        nf externalnetwork update-admin-state --resource-group "example-rg" --l3domain "example-l3domain" --resource-name "example-externalNetwork" --state "Enable"
    ```
