# [Command] _oracle-database exascale-db-storage-vault show_
...
- ExascaleDbStorageVaults_Show
    ```bash
        oracle-database exascale-db-storage-vault show --resource-group rgopenapi --exascale-db-storage-vault-name storagevault1
    ```
