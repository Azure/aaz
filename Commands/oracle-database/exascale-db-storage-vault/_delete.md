# [Command] _oracle-database exascale-db-storage-vault delete_
...
- ExascaleDbStorageVaults_Delete
    ```bash
        oracle-database exascale-db-storage-vault delete --resource-group rgopenapi --exascale-db-storage-vault-name storagevault1
    ```
