# [Command] _mobile-network attached-data-network delete_
...
- Delete attached-data-network
    ```bash
        mobile-network attached-data-network delete -n data-network-name --pccp-name pccp-name --pcdp-name pcdp-name -g rg -y
    ```
