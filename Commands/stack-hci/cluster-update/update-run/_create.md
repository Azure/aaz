# [Command] _stack-hci cluster-update update-run create_
...
- Create update run
    ```bash
        stack-hci cluster-update update-run create --cluster-name name -g rg  -n updates-run-name --update-name name
    ```
