...
- Show private endpoint connection
    ```bash
        fileshare private-endpoint-connection show --resource-group rgfileshares --resource-name fileshare --private-endpoint-connection-name privateEndpointConnection1
    ```
