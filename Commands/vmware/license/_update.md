# [Command] _vmware license update_
...
- Licenses_CreateOrUpdate
    ```bash
        vmware license update --resource-group group1 --private-cloud-name cloud1 --license-name VmwareFirewall --vmware-firewall contract-number=12345 site-id=site123 cores=100 end-date=2027-01-01T00:00:00Z license-key=12345-12345-12345-12345-12345
    ```
