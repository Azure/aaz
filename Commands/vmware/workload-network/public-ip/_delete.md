# [Command] _vmware workload-network public-ip delete_
...
- Delete a Public IP Block by ID in a workload network.
    ```bash
        vmware workload-network public-ip delete --resource-group group1 --public-ip publicIP1 --private-cloud cloud1
    ```
