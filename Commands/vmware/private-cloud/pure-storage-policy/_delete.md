# [Command] _vmware private-cloud pure-storage-policy delete_
...
- Delete a Pure Storage policy.
    ```bash
        vmware private-cloud pure-storage-policy delete --resource-group group1 --private-cloud-name cloud1 --storage-policy-name storagePolicy1
    ```
