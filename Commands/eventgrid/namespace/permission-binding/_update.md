# [Command] _eventgrid namespace permission-binding update_
...
- Update permission binding
    ```bash
        eventgrid namespace permission-binding update -g rg --namespace-name name -n permission-binding --client-group-name client-group --description test
    ```
