# [Command] _documentdb mongocluster microsoft-entra-user assign_
...
- Assign admin access to an Entra ID user (or service principal) by object ID.
    ```bash
        documentdb mongocluster microsoft-entra-user assign --object-id 11111111-1111-1111-1111-111111111111 --cluster-name MyCluster -g MyResourceGroup --type User --role db=admin role=root
    ```
