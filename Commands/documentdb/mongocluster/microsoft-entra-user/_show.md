# [Command] _documentdb mongocluster microsoft-entra-user show_
...
- Get an Entra ID user by object ID.
    ```bash
        documentdb mongocluster microsoft-entra-user show --object-id 11111111-1111-1111-1111-111111111111 --cluster-name MyCluster -g MyResourceGroup
    ```
