# [Command] _resiliency recovery-plan identity show_
...
- RecoveryPlans_Get_MaximumSet
    ```bash
        resiliency recovery-plan identity show --service-group-name sampleServiceGroupName --recovery-plan-name samplePlanName
    ```
