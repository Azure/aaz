# [Command] _resiliency recovery-plan identity remove_
...
- RecoveryPlans_CreateOrUpdate_MaximumSet
    ```bash
        resiliency recovery-plan identity remove --service-group-name sampleServiceGroupName --recovery-plan-name samplePlanName
    ```
