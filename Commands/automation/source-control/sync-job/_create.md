# [Command] _automation source-control sync-job create_
...
- Create source control sync job
    ```bash
        automation source-control sync-job create -g rg --automation-account-name myAutomationAccount --source-control-name sourceControl --job-id abcdef01-2345-6789-9bed-a01234567890 --commit-id ""
    ```
