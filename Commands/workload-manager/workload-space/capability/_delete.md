...
- Delete the Agent Sandbox capability
    ```bash
        workload-manager workload-space capability delete --resource-group rg-workload --space-name managed-agents-prod --capability-name agentSandbox
    ```
