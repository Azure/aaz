# [Command] _workload-manager workload-space capability create_
...
- Enable the Agent Sandbox capability
    ```bash
        workload-manager workload-space capability create --resource-group rg-workload --space-name managed-agents-prod --capability-name agentSandbox --location eastus2 --kind AgentSandbox --version-policy ServiceManaged
    ```
