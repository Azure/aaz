# [Command] _workload-manager workload-space runtime-link delete_

Delete a runtime link without deleting its runtime bindings.
...
- Delete a runtime link
    ```bash
        workload-manager workload-space runtime-link delete --resource-group rg-workload --space-name managed-agents-prod --link-name default
    ```
