# [Command] _purestorageblock reservation update_
...
- ReservationUpdateExample
    ```bash
        purestorageblock reservation show --resource-group rgpurestorage --reservation-name storagePoolname --subscription sub1 --tags {"aa":"bb"}
    ```
