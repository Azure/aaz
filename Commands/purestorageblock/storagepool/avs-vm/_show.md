# [Command] _purestorageblock storagepool avs-vm show_
...
- AvsVms_Get
    ```bash
        purestorageblock storage-pool avs-vm show --resource-group rgpurestorage --storage-pool-name storagePoolname --avs-vm-id cbdec-ddbb
    ```
