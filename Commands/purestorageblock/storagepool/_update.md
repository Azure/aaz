# [Command] _purestorageblock storagepool update_
...
- storage-pool Update
    ```bash
        purestorageblock storage-pool update --resource-group rgpurestorage --storage-pool-name storagePoolname --provisioned-bandwidth 908
    ```
