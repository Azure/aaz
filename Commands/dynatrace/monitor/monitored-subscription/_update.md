# [Command] _dynatrace monitor monitored-subscription update_
...
- Monitors_UpdateMonitoredSubscriptions
    ```bash
        dynatrace monitor monitored-subscription update --resource-group myResourceGroup --monitor-name myMonitor
    ```
