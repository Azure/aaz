# [Command] _dynatrace monitor monitored-subscription show_
...
- Monitors_GetMonitoredSubscriptions
    ```bash
        dynatrace monitor monitored-subscription show --resource-group myResourceGroup --monitor-name myMonitor
    ```
