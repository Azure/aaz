# [Command] _sig image-version delete_
...
### [2026-03-03](/Resources/mgmt-plane/L3N1YnNjcmlwdGlvbnMve30vcmVzb3VyY2Vncm91cHMve30vcHJvdmlkZXJzL21pY3Jvc29mdC5jb21wdXRlL2dhbGxlcmllcy97fS9pbWFnZXMve30vdmVyc2lvbnMve30=/2026-03-03.xml) **Stable**
...
- Permanently delete a gallery image version by bypassing soft delete.
    ```bash
        sig image-version delete --resource-group myResourceGroup --gallery-name myGalleryName --gallery-image-definition myGalleryImageName --gallery-image-version-name 1.0.0 --bypass-soft-delete true
    ```
