...
- Create a gallery with soft deletion enabled.
    ```bash
        sig create --resource-group myResourceGroup --gallery-name myGalleryName --location westus --soft-delete True --soft-delete-retention-period 7 --soft-delete-grace-period 30
    ```
