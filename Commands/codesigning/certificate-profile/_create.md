# [Command] _codesigning certificate-profile create_
...
- Create a certificate profile that includes street address in subject name of certificate
    ```bash
        codesigning certificate-profile create -g MyResourceGroup --account-name MyAccount -n MyProfile --profile-type PublicTrust --identity-validation-id xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx --include-street true
    ```
