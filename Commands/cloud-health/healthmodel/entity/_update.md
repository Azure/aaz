# [Command] _cloud-health healthmodel entity update_
...
- Update an entity's display name
    ```bash
        healthmodel entity update --resource-group myRG --health-model-name myModel --name webTier --display-name "Web Tier (PROD)"
    ```
