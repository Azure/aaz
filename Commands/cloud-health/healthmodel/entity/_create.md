# [Command] _cloud-health healthmodel entity create_
...
- Create an entity in a health model
    ```bash
        healthmodel entity create --resource-group myRG --health-model-name myModel --name webTier --display-name "Web Tier" --impact Standard
    ```
