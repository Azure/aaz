# [Command] _cloud-health healthmodel authentication-setting delete_
...
- Delete an authentication setting
    ```bash
        healthmodel authentication-setting delete --resource-group myRG --health-model-name myModel --name myAuth --yes
    ```
