# [Command] _cloud-health healthmodel authentication-setting show_
...
- Get an authentication setting
    ```bash
        healthmodel authentication-setting show --resource-group myRG --health-model-name myModel --name myAuth
    ```
