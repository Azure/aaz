# [Command] _cloud-health healthmodel signal-definition show_
...
- Get a signal definition
    ```bash
        healthmodel signal-definition show --resource-group myRG --health-model-name myModel --name cpuPressure
    ```
