# [Command] _cloud-health healthmodel signal-definition delete_
...
- Delete a signal definition
    ```bash
        healthmodel signal-definition delete --resource-group myRG --health-model-name myModel --name cpuPressure --yes
    ```
