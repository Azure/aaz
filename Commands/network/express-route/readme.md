...
- [get-circuit-link-failover-all-tests-detail](/Commands/network/express-route/_get-circuit-link-failover-all-tests-detail.md)
...
- [get-circuit-link-failover-single-test-detail](/Commands/network/express-route/_get-circuit-link-failover-single-test-detail.md)
...
- [start-circuit-link-failover-test](/Commands/network/express-route/_start-circuit-link-failover-test.md)
: This operation starts failover simulation on the circuit for the specified link type

- [stop-circuit-link-failover-test](/Commands/network/express-route/_stop-circuit-link-failover-test.md)
