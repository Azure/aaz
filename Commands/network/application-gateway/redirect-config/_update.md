# [Command] _network application-gateway redirect-config update_
...
- Update a redirect configuration to a different http-listener.
    ```bash
        network application-gateway redirect-config update -g MyResourceGroup --gateway-name MyAppGateway -n MyRedirectConfig --type Permanent --target-listener MyNewBackendListener
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.redirectConfigurations[] -->
