# [Command] _network application-gateway settings delete_
...
- Delete settings.
    ```bash
        network application-gateway settings delete -g MyResourceGroup --gateway-name MyAppGateway -n MyHttpSettings
    ```
