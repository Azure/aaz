# [Command] _network application-gateway root-cert show_
...
- Get the details of a trusted root certificate.
    ```bash
        network application-gateway root-cert show -g MyResourceGroup --gateway-name MyAppGateway -n MyRootCert
    ```
