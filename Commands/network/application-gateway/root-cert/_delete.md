# [Command] _network application-gateway root-cert delete_
...
- Delete a trusted root certificate.
    ```bash
        network application-gateway root-cert delete -g MyResourceGroup --gateway-name MyAppGateway -n MyRootCert
    ```
