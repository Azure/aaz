# [Command] _network application-gateway root-cert update_
...
- Update a trusted root certificate.
    ```bash
        network application-gateway root-cert update --cert-file FilePath --gateway-name MyGateway --name MyTrustedRootCertificate --resource-group MyResourceGroup
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2024-10-01 properties.trustedRootCertificates[] -->
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.trustedRootCertificates[] -->
