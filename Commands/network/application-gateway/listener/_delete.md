# [Command] _network application-gateway listener delete_
...
- Delete a listener.
    ```bash
        network application-gateway listener delete -g MyResourceGroup --gateway-name MyAppGateway -n MyListener
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2024-10-01 properties.listeners[] -->
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.listeners[] -->
