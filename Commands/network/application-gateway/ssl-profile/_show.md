# [Command] _network application-gateway ssl-profile show_
...
- Show SSL profile for an existing application gateway.
    ```bash
        network application-gateway ssl-profile show --gateway-name MyAppGateway -g MyResourceGroup --name MySslProfile
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.sslProfiles[] -->
