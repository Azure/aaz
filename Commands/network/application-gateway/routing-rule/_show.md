# [Command] _network application-gateway routing-rule show_
...
- Get the details of a rule.
    ```bash
        network application-gateway routing-rule show -g MyResourceGroup --gateway-name MyAppGateway -n MyRule
    ```
