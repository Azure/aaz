# [Command] _network application-gateway routing-rule delete_
...
- Delete a rule.
    ```bash
        network application-gateway routing-rule delete -g MyResourceGroup --gateway-name MyAppGateway -n MyRule
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2024-10-01 properties.routingRules[] -->
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.routingRules[] -->
