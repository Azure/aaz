# [Command] _network application-gateway frontend-port show_
...
- Get the details of a frontend port.
    ```bash
        network application-gateway frontend-port show -g MyResourceGroup --gateway-name MyAppGateway -n MyFrontendPort
    ```
