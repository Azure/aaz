# [Command] _network application-gateway rule delete_
...
- Delete a rule.
    ```bash
        network application-gateway rule delete -g MyResourceGroup --gateway-name MyAppGateway -n MyRule
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.requestRoutingRules[] -->
