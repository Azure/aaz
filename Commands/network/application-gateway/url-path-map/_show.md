# [Command] _network application-gateway url-path-map show_
...
- Get the details of a URL path map.
    ```bash
        network application-gateway url-path-map show -g MyResourceGroup --gateway-name MyAppGateway -n MyUrlPathMap
    ```
