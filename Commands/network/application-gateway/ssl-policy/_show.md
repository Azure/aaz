# [Command] _network application-gateway ssl-policy show_
...
- Get the details of an SSL policy settings.
    ```bash
        network application-gateway ssl-policy show -g MyResourceGroup --gateway-name MyAppGateway
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.sslPolicy -->
