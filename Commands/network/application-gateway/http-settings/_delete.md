# [Command] _network application-gateway http-settings delete_
...
- Delete HTTP settings.
    ```bash
        network application-gateway http-settings delete -g MyResourceGroup --gateway-name MyAppGateway -n MyHttpSettings
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.backendHttpSettingsCollection[] -->
