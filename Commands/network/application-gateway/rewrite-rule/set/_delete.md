# [Command] _network application-gateway rewrite-rule set delete_
...
- Delete a rewrite rule set.
    ```bash
        network application-gateway rewrite-rule set delete -g MyResourceGroup --gateway-name MyGateway -n MyRuleSet
    ```
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2024-10-01 properties.rewriteRuleSets[] -->
...
<!-- mgmt-plane /subscriptions/{}/resourcegroups/{}/providers/microsoft.network/applicationgateways/{} 2025-01-01 properties.rewriteRuleSets[] -->
