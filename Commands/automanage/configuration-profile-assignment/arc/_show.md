# [Command] _automanage configuration-profile-assignment arc show_
...
- show configuration-profile-assignment for arc
    ```bash
        automanage configuration-profile-assignment arc show -n default -g {rg} --machine-name {arc_name}
    ```
