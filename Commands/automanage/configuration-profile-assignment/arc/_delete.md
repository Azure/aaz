# [Command] _automanage configuration-profile-assignment arc delete_
...
- delete configuration-profile-assignment for arc
    ```bash
        automanage configuration-profile-assignment arc delete -n default -g {rg} --machine-name {arc_name}
    ```
